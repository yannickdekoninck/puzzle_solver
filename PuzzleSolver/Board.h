...
public:
    ...
    Board(int width, int height, std::vector<Piece *> &pieces) : GridView(width, height), pieces(pieces), lowest_open_neighbour_count(9), lowest_open_neighbour_location{0, 0}, max_solutions(-1) {}
